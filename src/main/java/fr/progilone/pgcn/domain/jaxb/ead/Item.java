...
public class Item {
    ...
    @XmlElementRefs({@XmlElementRef(name = "chronlist", namespace = "urn:isbn:1-931666-22-9", type = JAXBElement.class, required = false),
     ...
     * {@link JAXBElement }{@code <}{@link fr.progilone.pgcn.domain.jaxb.ead.List }{@code >}
