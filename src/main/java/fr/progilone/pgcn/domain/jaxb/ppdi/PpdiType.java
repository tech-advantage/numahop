...
/**
 * <p>Classe Java pour ppdiType complex type.
 * 
...
@XmlType(name = "ppdiType", propOrder = {
    "titre",
    "contexte",
    "caracteristiques"
})
public class PpdiType {
    ...
    /**
     * Obtient la valeur de la propri�t� contexte.
     * 
     * @return
     *     possible object is
     *     {@link ContexteType }
    ...
    /**
     * D�finit la valeur de la propri�t� contexte.
     * 
     * @param value
     *     allowed object is
     *     {@link ContexteType }
    ...
    /**
     * Obtient la valeur de la propri�t� caracteristiques.
     * 
     * @return
     *     possible object is
    ...
    /**
     * D�finit la valeur de la propri�t� caracteristiques.
     * 
     * @param value
     *     allowed object is
     *     {@link CaracteristiquesType }
