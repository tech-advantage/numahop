...
public interface LotRepository extends JpaRepository<Lot, String>, LotRepositoryCustom {
    ...
    @Query("from Lot l " + "left join fetch l.project "
           + "left join fetch l.platforms "
    ...
    @Query("from Lot l " + "join fetch l.project p "
    ...
    @Query("from Lot l " + "left join fetch l.project p "
           + "left join fetch l.platforms "
           + "left join fetch l.docUnits "
           + "left join fetch l.activeFTPConfiguration "
    ...
    @Query("from Lot lo " + "left join fetch lo.project p "
    ...
    @Query("from Lot lo " + "left join fetch lo.project "
    ...
    @Query("from Lot lo " + "left join fetch lo.docUnits du "
    ...
    @Query("from Lot lo " + "left join fetch lo.workflowModel wf "
