...
public interface DeliveryRepository extends JpaRepository<Delivery, String>, DeliveryRepositoryCustom {
    ...
    @Query("select distinct doc " + "from DeliveredDocument doc "
    ...
    @Modifying
    @Query("delete from DeliveredDocument doc " + "where doc.delivery.identifier = ?1 and doc.digitalDocument.identifier = ?2")
    ...
    @Query("select distinct del " + "from Delivery del "
