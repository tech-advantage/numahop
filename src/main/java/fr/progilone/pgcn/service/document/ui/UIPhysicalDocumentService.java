    ...
    private List<ListPhysicalDocumentDTO> getListeDtosWithSum(final List<PhysicalDocument> docs) {
        ...
        for (final ListPhysicalDocumentDTO pdto : physicalDtos) {
            ...
            if (report != null) {
                ...
                if (detail.isPresent()) {
                    final Integer dim1 = detail.get().getDim1() != null ? detail.get().getDim1()
                                                                        : 0;
                    final Integer dim2 = detail.get().getDim2() != null ? detail.get().getDim2()
                                                                        : 0;
                    final Integer dim3 = detail.get().getDim3() != null ? detail.get().getDim3()
                                                                        : 0;
                    maxDim1 = dim1 > maxDim1 ? dim1
                                             : maxDim1;
                    maxDim2 = dim2 > maxDim2 ? dim2
                                             : maxDim2;
                    maxDim3 = dim3 > maxDim3 ? dim3
                                             : maxDim3;
                    final Integer nbPg = detail.get().getNbViewTotal();
                    pdto.setTotalPage(nbPg);
                    somNbDocs += nbPg;

                    pdto.setReportDetailDim(String.valueOf(dim1).concat(" x ").concat(String.valueOf(dim2)).concat(" x ").concat(String.valueOf(dim3)));
                    final Double insurVal = detail.get().getInsurance() == null ? 0.0
                                                                                : detail.get().getInsurance();
                    ...
                    final Optional<Description> description = detail.get()
                                                                    .getDescriptions()
                                                                    .stream()
                                                                    .filter(desc -> DescriptionProperty.Type.VIGILANCE == desc.getProperty().getType() && "MAX_ANGLE".equals(desc
                                                                                                                                                                                 .getProperty()
                                                                                                                                                                                 .getCode()))
                                                                    .findFirst();
        ...
        somDto.setReportDetailDim(String.valueOf(maxDim1).concat(" x ").concat(String.valueOf(maxDim2)).concat(" x ").concat(String.valueOf(maxDim3)));
