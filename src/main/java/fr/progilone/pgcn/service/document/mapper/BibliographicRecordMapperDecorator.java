...
public abstract class BibliographicRecordMapperDecorator implements BibliographicRecordMapper {
    ...
    public BibliographicRecordMapperDecorator(BibliographicRecordMapper delegate) {
        this.delegate = delegate;
    }

    @Override
    public BibliographicRecordDTO bibliographicRecordToBibliographicRecordDTO(BibliographicRecord record) {
        BibliographicRecordDTO dto = delegate.bibliographicRecordToBibliographicRecordDTO(record);
    ...
    @Override
    public DocUnitBibliographicRecordDTO bibliographicRecordToDocUnitBibliographicRecordDTO(BibliographicRecord record) {
        DocUnitBibliographicRecordDTO dto = delegate.bibliographicRecordToDocUnitBibliographicRecordDTO(record);
    ...
    @Override
    public SimpleBibliographicRecordDTO bibliographicRecordToSimpleBibliographicRecordDTO(BibliographicRecord record) {
     ...
     * @param properties
     */
    private void createWeightedValueOrderByType(List<DocPropertyDTO> properties) {
     ...
     * @param properties
     */
    private void createWeightedValue(List<DocPropertyDTO> properties) {
        properties.forEach(property -> {
            final int rank = property.getRank() != null ? property.getRank() : 0;
