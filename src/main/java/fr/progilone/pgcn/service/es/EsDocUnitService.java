...
public class EsDocUnitService extends AbstractElasticsearchOperations<DocUnit> {
    ...
    public long reindex(final String index) {
        long nbImported = 0;
        Page<DocUnit> pageOfObjects = null;    // Chargement des objets par page de bulkSize éléments
        ...
        do {
            ...
            pageOfObjects = docUnitRepository.findAllByState(DocUnit.State.AVAILABLE, pageable);
