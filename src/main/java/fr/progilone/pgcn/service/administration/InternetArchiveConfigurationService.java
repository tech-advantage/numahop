...
public class InternetArchiveConfigurationService {
    ...
    public Page<InternetArchiveConfigurationDTO> search(String search, List<String> libraries, Integer page, Integer size) {
        ...
        List<InternetArchiveConfigurationDTO>
                results =
                        configurations.getContent().stream().map(InternetArchiveConfigurationMapper.INSTANCE::configurationIAToDto).collect(Collectors.toList());
    ...
    public void delete(final String id) {
        iaConfigurationRepository.delete(id);
    }
