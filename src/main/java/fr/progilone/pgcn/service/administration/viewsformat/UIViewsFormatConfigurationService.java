...
public class UIViewsFormatConfigurationService {
    ...
    public List<SimpleViewsFormatConfigurationDTO> getAllByProjectId(final String id) {
        ...
        return project.getLibrary().getViewsFormatConfigurations().stream().map(SimpleViewsFormatConfigurationMapper.INSTANCE::formatConfigToDto).collect(Collectors.toList());
    }
