...
public class WorkflowAccessHelper {
    ...
    @Autowired
    public WorkflowAccessHelper(final LotService lotService,
    ...
    public boolean canConstatDetailBeModified(final String docUnitId, final Type type) {
        switch(type) {
        case LIBRARY_LEAVING: return canElementLinkToStateBeDeleted(docUnitId, WorkflowStateKey.VALIDATION_CONSTAT_ETAT);
        case PROVIDER_RECEPTION: return canElementLinkToStateBeDeleted(docUnitId, WorkflowStateKey.CONSTAT_ETAT_AVANT_NUMERISATION);
        case DIGITALIZATION: return canElementLinkToStateBeDeleted(docUnitId, WorkflowStateKey.CONSTAT_ETAT_APRES_NUMERISATION);
        case LIBRARY_BACK: return true;
        default: return true;
