...
public class WorkflowModelController extends AbstractRestController {
    ...
    public ResponseEntity<WorkflowModelDTO> create(final HttpServletRequest request, @RequestBody final WorkflowModelDTO dto) throws PgcnException {
    ...
    public ResponseEntity<WorkflowModelDTO> update(final HttpServletRequest request, @RequestBody final WorkflowModelDTO dto) throws PgcnException {
        if (dto.getLibrary() != null && !libraryAccesssHelper.checkLibrary(request, dto.getLibrary().getIdentifier())) {
            return new ResponseEntity<>(HttpStatus.FORBIDDEN);
        }
