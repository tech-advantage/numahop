...
public class ViewsFormatConfigurationController extends AbstractRestController {
    ...
    @Autowired
    public ViewsFormatConfigurationController(final UIViewsFormatConfigurationService uiViewsFormatConfigurationService, final LibraryAccesssHelper libraryAccesssHelper) {
    ...
    public ResponseEntity<ViewsFormatConfigurationDTO> create(final HttpServletRequest request, @RequestBody final ViewsFormatConfigurationDTO formatConfiguration)
    ...
    public ResponseEntity<ViewsFormatConfigurationDTO> update(final HttpServletRequest request, @RequestBody final ViewsFormatConfigurationDTO configuration) throws PgcnException {
    ...
    @Timed
    @RolesAllowed({IMG_FORMAT_HAB0})
    public ResponseEntity<List<SimpleViewsFormatConfigurationDTO>> getByProjectId(final HttpServletRequest request, @RequestParam(value = "project") final String projectId) {
