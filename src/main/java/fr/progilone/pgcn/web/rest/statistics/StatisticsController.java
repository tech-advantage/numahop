...
public class StatisticsController extends AbstractRestController {
    ...
    public ResponseEntity<Page<StatisticsProgressDTO>> getProjectProgress(final HttpServletRequest request,
        ...
        return new ResponseEntity<>(statisticsProgressService.getProjectProgress(filteredLibraries, projects, fromDate, toDate, page, size),
                                    HttpStatus.OK);
    }
    ...
    public ResponseEntity<Page<StatisticsProgressDTO>> getLotProgress(final HttpServletRequest request,
        ...
        return new ResponseEntity<>(statisticsProgressService.getLotProgress(filteredLibraries, projects, fromDate, toDate, page, size),
                                    HttpStatus.OK);
    }
    ...
    public ResponseEntity<List<StatisticsProviderTrainDTO>> getProviderTrainStats(final HttpServletRequest request,
                                                                                  ...
                                                                                  @DateTimeFormat(pattern = "yyyy-MM-dd")
                                                                                  @RequestParam(name = "returnFrom", required = false)
                                                                                  final LocalDate returnFrom,
                                                                                  @DateTimeFormat(pattern = "yyyy-MM-dd")
                                                                                  @RequestParam(name = "returnTo", required = false)
                                                                                  final LocalDate returnTo,
                                                                                  @DateTimeFormat(pattern = "yyyy-MM-dd")
                                                                                  @RequestParam(name = "sendFrom", required = false)
                                                                                  final LocalDate sendFrom,
                                                                                  @DateTimeFormat(pattern = "yyyy-MM-dd")
                                                                                  @RequestParam(name = "sendTo", required = false)
                                                                                  final LocalDate sendTo,
                                                                                  @RequestParam(name = "insuranceFrom", required = false)
                                                                                  final Double insuranceFrom,
                                                                                  @RequestParam(name = "insuranceTo", required = false)
