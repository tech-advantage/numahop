        ...
        function ($provide) {
            ...
            $provide.value('$locale', {
                DATETIME_FORMATS: {
                    ...
                    ERAS: ['BC', 'AD'],
                    FIRSTDAYOFWEEK: 0,
                    MONTH: ['rags', 'wassarins', 'p\u016blis', 'sakkis', 'zallaws', 's\u012bmenis', 'l\u012bpa', 'daggis', 'sillins', 'spallins', 'lapkr\u016btis', 'sallaws'],
                    SHORTDAY: ['nad', 'pan', 'wis', 'pus', 'ket', 'p\u0113n', 'sab'],
                    SHORTMONTH: ['rag', 'was', 'p\u016bl', 'sak', 'zal', 's\u012bm', 'l\u012bp', 'dag', 'sil', 'spa', 'lap', 'sal'],
