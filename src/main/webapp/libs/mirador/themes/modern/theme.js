...
jsc*/
    ...
    define('tinymce.themes.modern.ui.Toolbar', ['tinymce.core.util.Tools', 'tinymce.core.ui.Factory'], function (Tools, Factory) {
        ...
        var addContextualToolbars = function (editor) {
            ...
            var reposition = function (match, shouldShow) {
                ...
                if (relPos) {
                    ...
                    if (elementRect) {
                        relPos = Rect.findBestRelativePosition(panelRect, elementRect, contentAreaRect, ['bc-tc', 'bl-tl', 'br-tr']);
    ...
    define('tinymce.themes.modern.ui.Sidebar', ['tinymce.core.util.Tools', 'tinymce.core.ui.Factory', 'tinymce.core.Env'], function (Tools, Factory, Env) {
        ...
        var render = function (editor, theme, args) {
            ...
            var render = function () {
                ...
                panel = theme.panel = Factory.create({
                    ...
                    border: 1,
                    items: [settings.menubar === false ? null : { type: 'menubar', border: '0 0 1 0', items: Menubar.createMenuButtons(editor) }, Toolbar.createToolbars(editor, settings.toolbar_items_size)],
                });
