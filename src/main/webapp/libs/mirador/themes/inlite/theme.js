...
jsc*/
    ...
    define('tinymce.themes.inlite.core.Measure', ['tinymce.core.dom.DOMUtils', 'tinymce.core.geom.Rect', 'tinymce.themes.inlite.core.Convert'], function (DOMUtils, Rect, Convert) {
    ...
    define('tinymce.themes.inlite.core.ElementMatcher', ['tinymce.themes.inlite.core.Matcher', 'tinymce.themes.inlite.core.Measure'], function (Matcher, Measure) {
    ...
    define('tinymce.themes.inlite.core.SelectionMatcher', ['tinymce.themes.inlite.core.Matcher', 'tinymce.themes.inlite.core.Measure'], function (Matcher, Measure) {
    ...
    define('tinymce.themes.inlite.core.SkinLoader', ['tinymce.core.EditorManager', 'tinymce.core.dom.DOMUtils'], function (EditorManager, DOMUtils) {
    ...
    define('tinymce.themes.inlite.ui.Toolbar', ['tinymce.core.util.Tools', 'tinymce.core.ui.Factory', 'tinymce.themes.inlite.alien.Type'], function (Tools, Factory, Type) {
     ...
     */
    define('tinymce.themes.inlite.alien.Unlink', ['tinymce.themes.inlite.alien.Bookmark', 'tinymce.core.util.Tools', 'tinymce.core.dom.TreeWalker', 'tinymce.core.dom.RangeUtils'], function (
        Bookmark,
        Tools,
        TreeWalker,
        RangeUtils
    ...
    define('tinymce.themes.inlite.core.Actions', ['tinymce.themes.inlite.alien.Uuid', 'tinymce.themes.inlite.alien.Unlink'], function (Uuid, Unlink) {
    ...
    define('tinymce.themes.inlite.ui.Forms', ['tinymce.core.util.Tools', 'tinymce.core.ui.Factory', 'tinymce.core.util.Promise', 'tinymce.themes.inlite.core.Actions', 'tinymce.themes.inlite.core.UrlType'], function (
        Tools,
        Factory,
        Promise,
        Actions,
    ...
    define('tinymce.themes.inlite.core.Layout', ['tinymce.core.geom.Rect', 'tinymce.themes.inlite.core.Convert'], function (Rect, Convert) {
        ...
        var calc = function (targetRect, contentAreaRect, panelRect) {
            return calcByPositions(['tc-bc', 'bc-tc', 'tl-bl', 'bl-tl', 'tr-br', 'br-tr'], ['bc-tc', 'bl-tl', 'br-tr'], targetRect, contentAreaRect, panelRect);
        };
    ...
    define('tinymce.themes.inlite.ui.Buttons', ['tinymce.themes.inlite.ui.Panel', 'tinymce.themes.inlite.file.Conversions', 'tinymce.themes.inlite.file.Picker', 'tinymce.themes.inlite.core.Actions'], function (
        Panel,
        Conversions,
        Picker,
        Actions
    ...
    define('tinymce.themes.inlite.Theme', [
    ...
    ], function (ThemeManager, Api, Delay, Arr, EditorSettings, ElementMatcher, Matcher, PredicateId, SelectionMatcher, SkinLoader, Buttons, Panel) {
        ...
        var getToolbars = function (editor) {
            ...
            return Arr.flatten([contextToolbars ? contextToolbars : [], createToolbar(editor, 'img', 'image', 'alignleft aligncenter alignright')]);
        };
