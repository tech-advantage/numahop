...
jsc*/
     ...
     * @private
     */
    define('tinymce.plugins.table.model.SplitCols', ['tinymce.core.util.Tools', 'tinymce.plugins.table.util.Utils'], function (Tools, Utils) {
     ...
     * @private
     */
    define('tinymce.plugins.table.model.TableGrid', ['tinymce.core.util.Tools', 'tinymce.core.Env', 'tinymce.plugins.table.util.Utils', 'tinymce.plugins.table.model.SplitCols'], function (Tools, Env, Utils, SplitCols) {
        var each = Tools.each,
        ...
        return function (editor, table, selectedCell) {
            ...
            function cloneCell(cell) {
                ...
                if (editor.settings.table_clone_elements !== false) {
                    cloneFormats = Tools.makeMap((editor.settings.table_clone_elements || 'strong em b i span font h1 h2 h3 h4 h5 h6 p div').toUpperCase(), /[ ,]/);
                }
     ...
     * @private
     */
    define('tinymce.plugins.table.selection.CellSelection', ['tinymce.plugins.table.model.TableGrid', 'tinymce.core.dom.TreeWalker', 'tinymce.core.util.Tools'], function (TableGrid, TreeWalker, Tools) {
    ...
    define('tinymce.plugins.table.ui.Dialogs', ['tinymce.core.util.Tools', 'tinymce.core.Env'], function (Tools, Env) {
        ...
        return function (editor) {
            ...
            function updateStyle(dom, win, isStyleCtrl) {
                ...
                if (isStyleCtrl) {
                    win.find('#borderColor')
                        .value(css['border-color'] || '')[0]
                        .fire('change');
                    win.find('#backgroundColor')
                ...
                if (isProps === true) {
                    ...
                    if (tableElm) {
                        data = {
                            ...
                            cellspacing: removePxSuffix(dom.getStyle(tableElm, 'border-spacing') || dom.getAttrib(tableElm, 'cellspacing')),
                            cellpadding: dom.getAttrib(tableElm, 'data-mce-cell-padding') || dom.getAttrib(tableElm, 'cellpadding') || getTDTHOverallStyle(tableElm, 'padding'),
                            border: dom.getAttrib(tableElm, 'data-mce-border') || dom.getAttrib(tableElm, 'border') || getTDTHOverallStyle(tableElm, 'border'),
     ...
     * @private
     */
    define('tinymce.plugins.table.ui.ResizeBars', ['tinymce.core.util.Tools', 'tinymce.core.util.VK'], function (Tools, VK) {
        var hoverTable;
        ...
        return function (editor) {
            ...
            function drawRows(rowPositions, tableWidth, tablePosition) {
                Tools.each(rowPositions, function (rowPosition) {
                    ...
                    editor.dom.add(getBody(), 'div', generateBar(RESIZE_BAR_ROW_CLASS, RESIZE_BAR_ROW_CURSOR_STYLE, left, top, height, width, RESIZE_BAR_ROW_DATA_ATTRIBUTE, rowPosition.index));
                });
            }
            ...
            function drawCols(cellPositions, tableHeight, tablePosition) {
                Tools.each(cellPositions, function (cellPosition) {
                    ...
                    editor.dom.add(getBody(), 'div', generateBar(RESIZE_BAR_COL_CLASS, RESIZE_BAR_COL_CURSOR_STYLE, left, top, height, width, RESIZE_BAR_COL_DATA_ATTRIBUTE, cellPosition.index));
                });
            }
            ...
            function getWidth(element, isPercentageBased, table) {
                ...
                if ((isPercentageBased && !isPercentageBasedSize(widthString)) || (!isPercentageBased && !isPixelBasedSize(widthString))) {
            ...
            function adjustWidth(table, delta, index) {
                ...
                function getNewTablePercentWidth() {
                    return index < tableGrid.grid.maxCols - 1 ? getCurrentTablePercentWidth(table) : getCurrentTablePercentWidth(table) + getTablePercentDelta(table, delta);
                }

                function getNewTablePixelWidth() {
                    return index < tableGrid.grid.maxCols - 1 ? getComputedStyleSize(table, 'width') : getComputedStyleSize(table, 'width') + delta;
                }
            ...
            function getBlockerElement() {
                ...
                blocker.setAttribute('style', 'margin: 0; ' + 'padding: 0; ' + 'position: fixed; ' + 'left: 0px; ' + 'top: 0px; ' + 'height: 100%; ' + 'width: 100%;');
     ...
     * @private
     */
    define('tinymce.plugins.table.util.Quirks', ['tinymce.core.util.VK', 'tinymce.core.util.Delay', 'tinymce.core.Env', 'tinymce.core.util.Tools', 'tinymce.plugins.table.util.Utils'], function (
        VK,
        Delay,
        Env,
        Tools,
        ...
        return function (editor) {
            ...
            function fixTableCaretPos() {
                ...
                editor.on('PreProcess', function (o) {
                    ...
                    if (
                        last &&
                        (last.nodeName == 'BR' || (last.childNodes.length == 1 && (last.firstChild.nodeName == 'BR' || last.firstChild.nodeValue == '\u00a0'))) &&
    ...
    define('tinymce.plugins.table.Plugin', [
        ...
        function Plugin(editor) {
            ...
            editor.on('PreInit', function () {
                ...
                editor.serializer.addAttributeFilter('data-mce-cell-padding,data-mce-border,data-mce-border-color', function (nodes, name) {
                    var i = nodes.length;
