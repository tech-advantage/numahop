    ...
    h('b', tinymce.util.Tools.resolve),
        ...
        g('d', ['4', 'c'], function (a, b) {
            var c = function (a, b, c) {
                ...
                g = function (a, c) {
                    for (var d, f = [], g = a[c], h = 0; h < g.length; h++) (d = g[h]), f.push({ elm: d.elm, above: e(a, h, c, -1) - 1, below: e(a, h, c, 1) - 1 }), (h += b.getColSpan(d.elm) - 1);
                    return f;
                },
                h = function (a, c) {
            ...
            return function (h, i, j) {
                                ...
                                (d += a),
                                    e(m(c, 'td,th'), function (a, c) {
                                        ...
                                        for (h = f(a, 'rowspan'), i = f(a, 'colspan'), g = d; g < d + h; g++)
                                            for (Z[g] || (Z[g] = []), e = c; e < c + i; e++) Z[g][e] = { part: b, real: g == d && e == c, elm: a, rowspan: h, colspan: i };
                                        $ = Math.max($, c + 1);
                                    });
                            }),
                                (a += d.length);
                ...
                function y(d) {
                    var f,
                        i = {};
                    return (
                        h.settings.table_clone_elements !== !1 && (i = a.makeMap((h.settings.table_clone_elements || 'strong em b i span font h1 h2 h3 h4 h5 h6 p div').toUpperCase(), /[ ,]/)),
                        a.walk(
                            d,
                            function (a) {
                                var c;
                    ...
                    return (
                        ...
                        0 === ca.select('tr', i).length
                            ...
                            : (e(ca.select('thead,tbody,tfoot', i), function (a) {
                              ...
                              n(),
                              void (_ && ((a = Z[Math.min(Z.length - 1, _.y)]), a && (ba.select(a[Math.min(a.length - 1, _.x)].elm, !0), ba.collapse(!0)))))
                    );
                }
                function A(a, b, c, d) {
                    var e, f, g, h, i;
                        ...
                        e(Z, function (d, e) {
                            ...
                            d[b] &&
                                ...
                                h != c &&
                                    ((j = f(h, 'colspan')),
                                    (i = f(h, 'rowspan')),
                                    1 == j ? (a ? (h.parentNode.insertBefore(y(h), h), A(b, e, i - 1, j)) : (ca.insertAfter(y(h), h), A(b, e, i - 1, j))) : g(h, 'colSpan', h.colSpan + 1),
                                    (c = h)));
                        });
                }
                function L(a, b) {
                        ...
                        e(j, function (a, b, d) {
                            ...
                            for (o(a), h = 0; h < n; h++)
                                (j = a.cells[h]),
                                    ...
                                    (k = f(j, 'rowspan')),
                                    (q += m),
                                    k > 1 && (q--, b + k > d.length ? ((k = d.length - b), g(j, 'rowSpan', k), l.push(d.length - 1)) : l.push(b + k - 1)),
                                    p(j);
                            for (
                                e(l, function (a) {
                                    b <= a && q++;
                ...
                function W(a) {
                    ...
                    if (((aa = T(a)), _ && aa)) {
                        ...
                        for (k(), l = c; l <= g; l++) for (j = b; j <= f; j++) Z[l][j] && ca.setAttrib(Z[l][j].elm, 'data-mce-selected', '1');
                    }
                }
                function X(a, b) {
                    var c, d, e;
                ...
                (o.tableProps = function () {
                    ...
                    (o.table = function (e) {
                                ...
                                d.undoManager.transact(function () {
                                    if ((p || (p = d.plugins.table.insertTable(w.cols || 1, w.rows || 1)), d.dom.setAttribs(p, { style: w.style, class: w['class'] }), d.settings.table_style_by_css)) {
                                        if (
                                            ...
                                            n(v, p, u),
                                            v.setAttribs(p, { 'data-mce-border-color': w.borderColor, 'data-mce-cell-padding': w.cellpadding, 'data-mce-border': w.border }),
                                            p.children)
                                        )
                        ...
                        e === !0
                            ...
                            d.settings.table_advtab !== !1
                                ? (m(v, w, p), d.windowManager.open({ title: 'Table properties', data: w, bodyType: 'tabpanel', body: [{ title: 'General', type: 'form', items: t }, f(v)], onsubmit: j }))
                    ...
                    (o.cell = function () {
                        ...
                        if (((s = d.dom.select('td[data-mce-selected],th[data-mce-selected]')), (o = d.dom.getParent(d.selection.getStart(), 'td,th')), !s.length && o && s.push(o), (o = o || s[0]))) {
                            s.length > 1
                                ? (p = { width: '', height: '', scope: '', class: '', align: '', style: '', type: o.nodeName.toLowerCase() })
                                : ((p = {
                            ...
                            d.settings.table_cell_advtab !== !1
                                ? d.windowManager.open({ title: 'Cell properties', bodyType: 'tabpanel', data: p, body: [{ title: 'General', type: 'form', items: t }, f(r)], onsubmit: n })
                        ...
                        (n = d.dom.getParent(d.selection.getStart(), 'table')),
                            ...
                            p &&
                                (u.length > 1
                                    ...
                                    : ((r = { height: g(t.getStyle(p, 'height') || t.getAttrib(p, 'height')), scope: t.getAttrib(p, 'scope'), class: t.getAttrib(p, 'class') }),
                                ...
                                d.settings.table_row_advtab !== !1
                                    ? d.windowManager.open({ title: 'Row properties', data: r, bodyType: 'tabpanel', body: [{ title: 'General', type: 'form', items: s }, f(t)], onsubmit: j })
        ...
        g('9', ['4', '5'], function (a, b) {
            ...
            return function (d) {
                ...
                function F(a, b, c, d) {
                    ...
                    else for (var f = a.slice(0, b).reverse(), g = 0; g < f.length; g++) f[g] && (e = { value: f[g], delta: g + 1 });
                    var h = a[b + 1];
            ...
            return function (h) {
                ...
                function j() {
                    ...
                    h.on('KeyDown', function (b) {
                        ...
                        (37 != b.keyCode && 38 != b.keyCode) ||
                            ...
                            d && h.getBody().firstChild == d && a(c, d) && ((c = e.createRng()), c.setStartBefore(d), c.setEndBefore(d), h.selection.setRng(c), b.preventDefault()));
                    });
                }
                function k() {
                    h.on('KeyDown SetContent VisualAid', function () {
                        ...
                        a &&
                            ...
                            (h.settings.forced_root_block
                                ? h.dom.add(h.getBody(), h.settings.forced_root_block, h.settings.forced_root_block_attrs, c.ie && c.ie < 10 ? '&nbsp;' : '<br data-mce-bogus="1" />')
                                : h.dom.add(h.getBody(), 'br', { 'data-mce-bogus': '1' }));
                    }),
                        h.on('PreProcess', function (a) {
                            var b = a.node.lastChild;
                            b &&
                                ('BR' == b.nodeName || (1 == b.childNodes.length && ('BR' == b.firstChild.nodeName || '\xa0' == b.firstChild.nodeValue))) &&
                                b.previousSibling &&
                ...
                function n() {
                    var b = '\ufeff',
                        ...
                        i = function (a, c) {
                            var d;
                            (d = c ? h.dom.create('p', { 'data-mce-caret': 'after', 'data-mce-bogus': 'all' }, '<br data-mce-bogus="1">') : a.ownerDocument.createTextNode(b)), a.appendChild(d);
                        },
                        j = function (a, d) {
                            var e = a.lastChild,
                        ...
                        k = function (a) {
                            ...
                            b.commonAncestorContainer === a.parentNode &&
                                ...
                                (c.setStart(a, 0), 1 === d.nodeType ? c.setEnd(a, a.childNodes.length) : c.setEnd(d, d.nodeValue.length), h.selection.setRng(c));
                        };
                    h.on('keydown', function (b) {
            ...
            function k(a) {
                ...
                function r() {
                    a.addButton('tableprops', { title: 'Table properties', onclick: z.tableProps, icon: 'table' }),
                        ...
                        a.addButton('tableinsertcolbefore', { title: 'Insert column before', onclick: c('mceTableInsertColBefore') }),
                ...
                function t() {
                    ...
                    '' !== b &&
                        b !== !1 &&
                        (b || (b = 'tableprops tabledelete | tableinsertrowbefore tableinsertrowafter tabledeleterow | tableinsertcolbefore tableinsertcolafter tabledeletecol'), a.addContextToolbar(s, b));
                }
                function u() {
                    return w;
                }
                ...
                var w,
                    ...
                    y = this,
                    z = new h(a);
                !a.settings.object_resizing || a.settings.table_resize_bars === !1 || (a.settings.object_resizing !== !0 && 'table' !== a.settings.object_resizing) || (x = i(a)),
                              ...
                              menu: [
                                  {
                                      ...
                                      onmousemove: function (a) {
                                          ...
                                          'A' == d.tagName.toUpperCase() &&
                                              ...
                                              (b === this.lastX && c === this.lastY) || (q(b, c, a.control), (this.lastX = b), (this.lastY = c)));
                                      },
                                      onclick: function (b) {
                                          var c = this;
                    ...
                    a.addMenuItem('tableprops', { text: 'Table properties', context: 'table', onPostRender: m, onclick: z.tableProps }),
                    a.addMenuItem('deletetable', { text: 'Delete table', context: 'table', onPostRender: m, cmd: 'mceTableDelete' }),
                    a.addMenuItem('cell', {
                        separator: 'before',
                        text: 'Cell',
                        context: 'table',
