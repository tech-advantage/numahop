                    ...
                    a.settings.forced_root_block !== !1 &&
                        ...
                        a.addCommand('mceVisualChars', function () {
                            var b,
                                f = a.getBody(),
                                g = a.selection;
                            (c = !c), (d.state = c), a.fire('VisualChars', { state: c }), (b = g.getBookmark()), c === !0 ? e.show(a, f) : e.hide(a, f), g.moveToBookmark(b);
                        }),
                        a.addButton('visualchars', { title: 'Show invisible characters', cmd: 'mceVisualChars', onPostRender: f }),
                        a.addMenuItem('visualchars', { text: 'Show invisible characters', cmd: 'mceVisualChars', onPostRender: f, selectable: !0, context: 'view', prependToContext: !0 });
                }),
                function () {}
            );
        }),
