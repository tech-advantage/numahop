...
jsc*/
    ...
    define('tinymce.plugins.media.core.Sanitize', ['tinymce.core.util.Tools', 'tinymce.core.html.Writer', 'tinymce.core.html.SaxParser', 'tinymce.core.html.Schema'], function (Tools, Writer, SaxParser, Schema) {
    ...
    define('tinymce.plugins.media.core.Nodes', ['tinymce.plugins.media.core.Sanitize', 'tinymce.plugins.media.core.VideoScript', 'tinymce.core.html.Node', 'tinymce.core.Env'], function (
        Sanitize,
        VideoScript,
        Node,
        Env
    ...
    define('tinymce.plugins.media.core.UpdateHtml', ['tinymce.core.html.Writer', 'tinymce.core.html.SaxParser', 'tinymce.core.html.Schema', 'tinymce.core.dom.DOMUtils', 'tinymce.plugins.media.core.Size'], function (
        Writer,
        SaxParser,
        Schema,
        DOMUtils,
    ...
    define('tinymce.plugins.media.core.Service', ['tinymce.plugins.media.core.DataToHtml', 'tinymce.core.util.Promise'], function (DataToHtml, Promise) {
    ...
    define('tinymce.plugins.media.ui.Dialog', [
        ...
        var getData = function (editor) {
            ...
            return element.getAttribute('data-mce-object') ? HtmlToData.htmlToData(editor.settings.media_scripts, editor.serializer.serialize(element, { selection: true })) : {};
        };
