                        ...
                        f.isCollapsed() &&
                            ...
                            3 == i.nodeType &&
                                ...
                                void 0 !== n &&
                                    ...
                                    k !== -1 && ((m = g.createRng()), m.setStart(i, k), m.setEnd(i, j - o), (n = c.findPattern(b, m.toString())), n && n.end && !(i.data.length <= n.start.length + n.end.length))))))
                    )
                        return (
                ...
                f = function (d, e) {
                    ...
                    if (((f = d.selection), (g = d.dom), f.isCollapsed() && (l = g.getParent(f.getStart(), 'p')))) {
                        ...
                        if (i) {
                            ...
                            m.format && ((k = d.formatter.get(m.format)), k && k[0].block && (i.deleteData(0, m.start.length), d.formatter.apply(m.format, {}, i), o.setStart(h, p), o.collapse(!0), f.setRng(o))),
                                m.cmd &&
