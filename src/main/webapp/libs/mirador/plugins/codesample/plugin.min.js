                ...
                c.languages.markup &&
                    (c.languages.insertBefore('markup', 'tag', {
                        style: {
                            ...
                            inside: { tag: { pattern: /<style[\w\W]*?>|<\/style>/i, inside: c.languages.markup.tag.inside }, rest: c.languages.css },
                            alias: 'language-css',
                        },
                    }),
                ...
                c.languages.markup &&
                    c.languages.insertBefore('markup', 'tag', {
                        script: {
                            ...
                            inside: { tag: { pattern: /<script[\w\W]*?>|<\/script>/i, inside: c.languages.markup.tag.inside }, rest: c.languages.javascript },
        ...
        g('4', ['7', '3', '5'], function (a, b, c) {
            ...
            function e(a, c, d) {
                a.undoManager.transact(function () {
                    ...
                    (d = i.encode(d)),
                        e
                            ? (a.dom.setAttrib(e, 'class', 'language-' + c), (e.innerHTML = d), b.highlightElement(e), a.selection.select(e))
                            : (a.insertContent('<pre id="__new" class="language-' + c + '">' + d + '</pre>'), a.selection.select(a.$('#__new').removeAttr('id')[0]));
                });
            }
            function f(a) {
                ...
                open: function (a) {
                    a.windowManager.open({
                        ...
                        body: [
                            ...
                            { type: 'textbox', name: 'code', multiline: !0, spellcheck: !1, ariaLabel: 'Code view', flex: 1, style: 'direction: ltr; text-align: left', classes: 'monospace', value: g(a), autofocus: !0 },
                        ],
                        onSubmit: function (b) {
                ...
                b.add('codesample', function (b, h) {
                    function i() {
                        ...
                        (b.inline && f) ||
                            (!b.inline && j) ||
                            (b.inline ? (f = !0) : (j = !0),
                            c !== !1 && ((a = b.dom.create('link', { rel: 'stylesheet', href: c ? c : h + '/css/prism.css' })), b.getDoc().getElementsByTagName('head')[0].appendChild(a)));
                    }
                    var j,
                        k = b.$;
                    a.ceFalse &&
