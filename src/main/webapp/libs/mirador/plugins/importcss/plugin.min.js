            ...
            return (
                d.add('importcss', function (d) {
                    ...
                    function g(b) {
                        ...
                        if (e) {
                            var f = c.skin_url;
                            return (f = f ? d.documentBaseURI.toAbsolute(f) : a.baseURL + '/skins/' + e), b === f + '/content' + (d.inline ? '.inline' : '') + '.min.css';
                        }
                        return !1;
                    }
                    function h(a) {
                    ...
                    function j(a) {
                        ...
                        if (c) {
                            ...
                            return (
                                c[1]
                                    ? ((b = { title: a }), d.schema.getTextBlockElements()[f] ? (b.block = f) : d.schema.getBlockElements()[f] || h[f.toLowerCase()] ? (b.selector = f) : (b.inline = f))
                    ...
                    function p(a, b, c) {
                        var e,
                            f = d.settings;
                        return (e = c && c.selector_converter ? c.selector_converter : f.importcss_selector_converter ? f.importcss_selector_converter : j), e.call(a, b, c);
                    }
                    var q = this,
                        r = e.each;
                            ...
                            s = function (a, c) {
                                if (n(a, c, f)) {
                                    ...
                                    if (g) {
                                        ...
                                        return d.formatter.register(h, g), e.extend({}, j.settings.itemDefaults, { text: g.title, format: h });
                                    }
                                }
                                return null;
                            };
