...
jsc*/
     ...
     * @private
     */
    define('tinymce.plugins.importcss.Plugin', ['tinymce.core.EditorManager', 'tinymce.core.dom.DOMUtils', 'tinymce.core.Env', 'tinymce.core.PluginManager', 'tinymce.core.util.Tools'], function (
        EditorManager,
        DOMUtils,
        Env,
        PluginManager,
