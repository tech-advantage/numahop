                ...
                a.add('visualblocks', function (a, b) {
                    ...
                    window.NodeList &&
                        (a.addCommand('mceVisualBlocks', function () {
                            var c,
                                g = a.dom;
                            d || ((d = g.uniqueId()), (c = g.create('link', { id: d, rel: 'stylesheet', href: b + '/css/visualblocks.css' })), a.getDoc().getElementsByTagName('head')[0].appendChild(c)),
                        ...
                        a.addMenuItem('visualblocks', { text: 'Show blocks', cmd: 'mceVisualBlocks', onPostRender: c, selectable: !0, context: 'view', prependToContext: !0 }),
                        a.on('init', function () {
