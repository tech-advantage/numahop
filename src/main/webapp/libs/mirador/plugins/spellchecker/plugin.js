...
jsc*/
    ...
    define('tinymce.plugins.spellchecker.Plugin', [
        ...
        PluginManager.add('spellchecker', function (editor, url) {
            ...
            var languagesString = settings.spellchecker_languages || 'English=en,Danish=da,Dutch=nl,Finnish=fi,French=fr_FR,' + 'German=de,Italian=it,Polish=pl,Portuguese=pt_BR,' + 'Spanish=es,Swedish=sv';
            ...
            function defaultSpellcheckCallback(method, text, doneCallback, errorCallback) {
                ...
                XHR.send({
                    ...
                    error: function () {
                        var message = editor.translate('The spelling service was not found: (') + settings.spellchecker_rpc_url + editor.translate(')');
                        errorCallback(message);
                    },
                });
            }
