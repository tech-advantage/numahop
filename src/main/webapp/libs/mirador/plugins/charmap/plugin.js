...
jsc*/
     ...
     * @private
     */
    define('tinymce.plugins.charmap.Plugin', ['tinymce.core.PluginManager', 'tinymce.core.util.Tools'], function (PluginManager, Tools) {
                ...
                for (y = 0; y < height; y++) {
                    ...
                    for (x = 0; x < width; x++) {
                        ...
                        if (index < charmap.length) {
                            ...
                            gridHtml += '<td title="' + chr[1] + '">' + '<div tabindex="-1" title="' + chr[1] + '" role="button" data-chr="' + chrText + '">' + chrText + '</div>' + '</td>';
                        } else {
                            gridHtml += '<td />';
                        }
                    }
