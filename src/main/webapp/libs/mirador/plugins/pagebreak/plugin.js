...
jsc*/
     ...
     * @private
     */
    define('tinymce.plugins.pagebreak.Plugin', ['tinymce.core.PluginManager', 'tinymce.core.Env'], function (PluginManager, Env) {
        PluginManager.add('pagebreak', function (editor) {
            ...
            var pageBreakPlaceHolderHtml = '<img src="' + Env.transparentSrc + '" class="' + pageBreakClass + '" data-mce-resize="false" data-mce-placeholder />';
