...
jsc*/
     ...
     * @private
     */
    define('tinymce.plugins.autoresize.Plugin', ['tinymce.core.dom.DOMUtils', 'tinymce.core.Env', 'tinymce.core.PluginManager', 'tinymce.core.util.Delay'], function (DOMUtils, Env, PluginManager, Delay) {
        ...
        PluginManager.add('autoresize', function (editor) {
             ...
             */
            function resize(e) {
                var deltaSize, doc, body, docElm, resizeHeight, myHeight, marginTop, marginBottom, paddingTop, paddingBottom, borderTop, borderBottom;
