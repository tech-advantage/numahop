...
jsc*/
     ...
     * Contributing: http://www.tinymce.com/contributing
     */
    define('tinymce.plugins.wordcount.text.StringMapper', ['tinymce.plugins.wordcount.text.UnicodeData', 'tinymce.plugins.wordcount.alien.Arr'], function (UnicodeData, Arr) {
    ...
    define('tinymce.plugins.wordcount.text.WordBoundary', ['tinymce.plugins.wordcount.text.UnicodeData'], function (UnicodeData) {
    ...
    define('tinymce.plugins.wordcount.text.WordGetter', ['tinymce.plugins.wordcount.text.UnicodeData', 'tinymce.plugins.wordcount.text.StringMapper', 'tinymce.plugins.wordcount.text.WordBoundary'], function (
        UnicodeData,
        StringMapper,
        WordBoundary
    ) {
    ...
    define('tinymce.plugins.wordcount.Plugin', ['tinymce.core.PluginManager', 'tinymce.core.util.Delay', 'tinymce.plugins.wordcount.text.WordGetter'], function (PluginManager, Delay, WordGetter) {
