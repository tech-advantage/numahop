...
jsc*/
    ...
    */
    ...
    define('tinymce.plugins.help.ui.KeyboardShortcutsTab', ['ephox.katamari.api.Arr', 'tinymce.plugins.help.data.KeyboardShortcuts'], function (Arr, KeyboardShortcuts) {
        var makeTab = function () {
            ...
            var shortcutLisString = Arr.map(KeyboardShortcuts.shortcuts, function (shortcut) {
                return '<tr data-mce-tabstop="1" tabindex="-1" ' + makeAriaLabel(shortcut) + '>' + '<td>' + shortcut.action + '</td>' + '<td>' + shortcut.shortcut + '</td>' + '</tr>';
            }).join('');
            ...
            return {
                ...
                items: [
                    {
                        type: 'container',
                        html: '<div>' + '<table class="mce-table-striped">' + '<thead>' + '<th>Action</th>' + '<th>Shortcut</th>' + '</thead>' + shortcutLisString + '</table>' + '</div>',
                    },
                ],
            };
        };
...
-     */
    ...
    define('ephox.katamari.api.Strings', ['ephox.katamari.str.StrAppend', 'ephox.katamari.str.StringParts', 'global!Error'], function (StrAppend, StringParts, Error) {
    ...
    define('tinymce.plugins.help.ui.Dialog', ['tinymce.core.EditorManager', 'tinymce.plugins.help.ui.KeyboardShortcutsTab', 'tinymce.plugins.help.ui.PluginsTab', 'tinymce.plugins.help.ui.ButtonsRow'], function (
        EditorManager,
    ...
    define('tinymce.plugins.help.Plugin', ['tinymce.core.PluginManager', 'tinymce.plugins.help.ui.Dialog'], function (PluginManager, Dialog) {
