...
jsc*/
     ...
     * @private
     */
    define('tinymce.plugins.insertdatetime.Plugin', ['tinymce.core.PluginManager', 'tinymce.core.util.Tools'], function (PluginManager, Tools) {
        PluginManager.add('insertdatetime', function (editor) {
            ...
            Tools.each(editor.settings.insertdatetime_formats || ['%H:%M:%S', '%Y-%m-%d', '%I:%M:%S %p', '%D'], function (fmt) {
