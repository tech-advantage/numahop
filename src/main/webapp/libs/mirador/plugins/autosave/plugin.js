...
jsc*/
     ...
     * @private
     */
    define('tinymce.plugins.autosave.Plugin', ['tinymce.core.EditorManager', 'tinymce.core.PluginManager', 'tinymce.core.util.LocalStorage', 'tinymce.core.util.Tools', 'global!window'], function (
        EditorManager,
        PluginManager,
        LocalStorage,
        Tools,
