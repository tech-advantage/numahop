...
jsc*/
    ...
    define('tinymce.plugins.link.core.Utils', ['tinymce.core.util.Tools', 'tinymce.plugins.link.core.Settings', 'global!RegExp'], function (Tools, Settings, RegExp) {
    ...
    define('tinymce.plugins.link.ui.Dialog', ['tinymce.core.util.Delay', 'tinymce.core.util.Tools', 'tinymce.core.util.XHR', 'tinymce.plugins.link.core.Utils', 'tinymce.plugins.link.core.Settings'], function (
        Delay,
        Tools,
        XHR,
        Utils,
    ...
    define('tinymce.plugins.link.core.OpenUrl', ['tinymce.core.dom.DOMUtils', 'tinymce.core.Env'], function (DOMUtils, Env) {
    ...
    define('tinymce.plugins.link.ui.Controls', ['tinymce.plugins.link.core.Actions', 'tinymce.plugins.link.core.Utils'], function (Actions, Utils) {
    ...
    define('tinymce.plugins.link.Plugin', ['tinymce.core.PluginManager', 'tinymce.plugins.link.core.Actions', 'tinymce.plugins.link.ui.Controls'], function (PluginManager, Actions, Controls) {
