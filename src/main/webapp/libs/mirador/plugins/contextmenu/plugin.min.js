                ...
                c.add('contextmenu', function (a) {
                    ...
                    return (
                        ...
                        a.on('contextmenu', function (b) {
                            var f;
                            if (!j(b)) {
                                if ((n(b, a.selection.getRng()) && a.selection.select(b.target), b.preventDefault(), (f = a.settings.contextmenu || 'link openlink image inserttable | cell row column deletetable'), c))
                                    c.show();
                                else {
                                    var i = [];
