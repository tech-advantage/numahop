...
jsc*/
     ...
     * @private
     */
    define('tinymce.plugins.image.Plugin', ['tinymce.core.Env', 'tinymce.core.PluginManager', 'tinymce.core.util.JSON', 'tinymce.core.util.Tools', 'tinymce.core.util.XHR'], function (
        Env,
        PluginManager,
        JSON,
        Tools,
