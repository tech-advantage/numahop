(function () {
    ...
    angular.module('numaHopApp').factory('AuthAdmin', function AuthAdmin($rootScope, $state, $q, Principal, AuthServerProvider, Account, Register, Activate, Password, PasswordResetInit, PasswordResetFinish, Tracker) {
        return {
