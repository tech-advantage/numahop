(function () {
    ...
    angular.module('numaHopApp.controller').controller('SemEditableFieldCtrl', function ($scope, $element, $attrs, $transclude, $parse, ErreurSrvc, gettextCatalog, MessageSrvc) {
