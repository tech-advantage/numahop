(function () {
    ...
    angular.module('numaHopApp.directive').directive('semEditableForm', function () {
        return {
            restrict: 'E',
            scope: {
            ...
            compile: function compile(tElement, tAttrs, transclude) {
                ...
                tElement.find('sem-editable-field:not(sem-editable-block sem-editable-field)').attr('sem-form', tAttrs.semName);

                // Affichage des erreurs
                var errorElt = angular.element(
                    '<blockquote ng-if="errText" class="col-sm-offset-3 col-sm-9 alert-danger">' +
                ...
                if (angular.isDefined(tAttrs.ngReadonly)) {
                    ...
                    tElement.find('sem-editable-field[ng-readonly], sem-editable-block-header[ng-readonly]').each(function (index, element) {
                        var $this = $(this);
