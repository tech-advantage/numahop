(function () {
     ...
     *   };
     */
    angular.module('numaHopApp.directive').directive('editableUiselect', function (editableDirectiveFactory) {
        return editableDirectiveFactory({
            directiveName: 'editableUiselect',
            inputTpl:
                '<ui-select theme="select2" style="min-width:150px" ng-disabled="readonly()">' +
            ...
            render: function () {
                ...
                var filterExpr = isAsync || options.filter ? 'filterData' : options.displayFn ? '$select.search' : '{' + options.display + ': $select.search}';
