        ...
        .factory(
            ...
            function (
                ...
                var loadRoles = function () {
                    return UserRoleSrvc.query({ dto: 'true' }).$promise.then(function (roles) {
                ...
                var loadPACS = function (library, project) {
                    return SFTPConfigurationSrvc.pacs({ library: library, project: project }).$promise.then(function (pacs) {
                ...
                var loadExportFtpConf = function (libraryId) {
                    return ExportFTPConfigurationSrvc.findByLibrary({ libraryId: libraryId }).$promise.then(function (confExport) {
                ...
                var loadCinesParamsDefaultValues = function (id) {
                    return LibraryParameterSrvc.cinesDefaultValues({ sftpConfig: id }).$promise.then(function (defaultValues) {
                        return defaultValues;
                    });
                };

                var loadCollections = function (library, project) {
                    return IAConfigurationSrvc.collections({ library: library, project: project }).$promise.then(function (ias) {
                ...
                var loadOmekaCollections = function (omekaConf, project) {
                    return OmekaConfigurationSrvc.omekacollections({ omekaConf: omekaConf, project: project }).$promise.then(function (colls) {
                ...
                var loadOmekaItems = function (omekaConf, project) {
                    return OmekaConfigurationSrvc.omekaitems({ omekaConf: omekaConf, project: project }).$promise.then(function (items) {
                ...
                var loadOmekaConfigurations = function (library, project) {
                    return OmekaConfigurationSrvc.configurations({ library: library, project: project, active: true }).$promise.then(function (items) {
                        return _.sortBy(items, function (it) {
                            return it.name ? it.name.toLowerCase() : it;
                        });
                    });
                ...
                var loadUsersForLibrary = function (library) {
                    if (library) {
                        return LibrarySrvc.users({ id: library }).$promise.then(function (users) {
                ...
                var loadLots = function (libraries, projects, screenTarget) {
                    if (projects && projects.length) {
                        return LotSrvc.query({ dto: 'true', projects: projects }).$promise.then(function (lots) {
                            return _.sortBy(lots, function (lot) {
                                return lot.label.toLowerCase();
                            });
                        });
                    } else if (libraries && libraries.length) {
                        return LotSrvc.query({ dto: 'true', libraries: libraries }).$promise.then(function (lots) {
                            return _.sortBy(lots, function (lot) {
                                return lot.label.toLowerCase();
                            });
                        });
                    } else {
                        return LotSrvc.query({ dto: 'true', target: screenTarget }).$promise.then(function (lots) {
                            return _.sortBy(lots, function (lot) {
                                return lot.label.toLowerCase();
                            });
                        });
                ...
                var loadProjects = function (libraries) {
                    return ProjectSrvc.dto({ libraries: libraries }).$promise.then(function (projects) {
                ...
                var loadCompleteLots = function (libraries, projects, screenTarget) {
                    if (projects && projects.length) {
                        return LotSrvc.query({ dto: 'true', complete: 'true', projects: projects }).$promise.then(function (lots) {
                            return _.sortBy(lots, function (lot) {
                                return lot.label.toLowerCase();
                            });
                        });
                    } else if (libraries && libraries.length) {
                        return LotSrvc.query({ dto: 'true', complete: 'true', libraries: libraries }).$promise.then(function (lots) {
                            return _.sortBy(lots, function (lot) {
                                return lot.label.toLowerCase();
                            });
                        });
                    } else {
                        return LotSrvc.query({ dto: 'true', complete: 'true', target: screenTarget }).$promise.then(function (lots) {
                            return _.sortBy(lots, function (lot) {
                                return lot.label.toLowerCase();
                            });
                        });
                ...
                var loadCompleteProjects = function (libraries) {
                    return ProjectSrvc.query({ dto2: 'true', complete: 'true', libraries: libraries }).$promise.then(function (projects) {
                        return _.sortBy(projects, function (pj) {
                            return pj.name.toLowerCase();
                        });
                    });
                ...
                var loadOcrLanguagesForLibrary = function (library) {
                    if (AuthenticationSharedService.isAuthorized(USER_ROLES.OCR_LANG_HAB0)) {
                        return OcrLanguageSrvc.langs({ library: library }).$promise.then(function (langs) {
