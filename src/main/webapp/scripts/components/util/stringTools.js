(function () {
    ...
    angular.module('numaHopApp.utils').factory('StringTools', function ($log, gettextCatalog) {
        ...
        var evalFormula = function (formula, data) {
            ...
            try {
                ...
                var message = gettextCatalog.getString("Une erreur est survenue lors de l'évaluation de ce champ calculé");
