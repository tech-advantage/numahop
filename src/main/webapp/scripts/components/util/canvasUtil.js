(function () {
	...
	angular.module('numaHopApp.utils')
		.factory('canvasUtil', canvasUtil);
		...
		var drawCanvas = function (canvas) {
			if (stateElements) {
				...
				stateElements.forEach(function (state) {
					...
					state.width = 200;
					switch (state.type) {
						case 'START': context.fillStyle = '#7CFC00';
							state.width = 100;
							break;
						case 'STATE_OPTIONAL': context.fillStyle = '#7FFFD4';
							break;
						case 'STATE_MANDATORY': context.fillStyle = '#1E90FF';
							break;
						case 'STATE_WAIT': context.fillStyle = '#C0C0C0';
							break;
						case 'STATE_CONDITIONAL': context.fillStyle = '#F4A460';
							break;
						case 'END': context.fillStyle = '#F08080';
							state.width = 100;
							break;
					}
