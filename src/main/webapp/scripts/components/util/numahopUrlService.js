(function () {
    ...
    angular.module('numaHopApp.service').factory('NumahopUrlService', NumahopUrlService);

    function NumahopUrlService($resource, gettext, CONFIGURATION, $httpParamSerializer) {
        var service = $resource(
            CONFIGURATION.numahop.url + 'app/rest/url/:id',
            {
                id: '@identifier',
            },
            {
        ...
        function parameterizedUrl(type, parameters) {
            ...
            switch (type) {
                case 'role':
                    ...
                    break;
                case 'record':
                    url = url + 'document/record';
                    break;
                case 'digital_document':
                    url = url + 'document/digital';
                    break;
                ...
                case 'viewer_sample':
                    url = url + 'viewer/viewer';
                    break;
                case 'ftpConfiguration':
                    url = url + 'platformconfiguration/ftpconfiguration';
                    break;
                case 'exportftpConfiguration':
                    url = url + 'platformconfiguration/exportftpconfiguration';
                    break;
                case 'sftpConfiguration':
                    url = url + 'platformconfiguration/sftpconfiguration';
                    break;
                case 'iaConfiguration':
                    url = url + 'platformconfiguration/iaconfiguration';
                    break;
                case 'omekaConfiguration':
                    url = url + 'platformconfiguration/omekaconfiguration';
                    break;
                case 'digitalLibraryConfiguration':
                    url = url + 'platformconfiguration/digitallibraryconfiguration';
                    break;
                case 'checkConfiguration':
                    url = url + 'checkconfiguration/checkconfiguration';
                    break;
                case 'ocrlangConfiguration':
                    url = url + 'ocrlangconfiguration/ocrlangconfiguration';
                    break;
                case 'formatConfiguration':
                    url = url + 'administration/appconfiguration/viewsformat';
                    break;
                case 'viewsformat':
                    url = url + 'viewsformat/viewsformat';
                    break;
                case 'checks':
                    url = url + 'document/checks';
                    break;
                case 'workflowModel':
                    url = url + 'workflow/model';
                    break;
                case 'workflowGroup':
                    url = url + 'workflow/group';
                    break;
                case 'multiLotsDelivery':
                    url = url + 'multilotsdelivery/multidelivery';
                    break;
