(function () {
    ...
    angular.module('numaHopApp.service').factory('ErreurSrvc', function (gettextCatalog) {
        var errors = {
            ...
            CONDREPORT_DETAIL_DESC_NO_VALUE_FOR_PROP: gettextCatalog.getString("Erreur de mapping sur le constat d'état: valeur non trouvée"),
            CONDREPORT_DETAIL_DESC_BAD_VALUE: gettextCatalog.getString("Erreur de mapping sur le constat d'état: mauvaise valeur"),
            CONDREPORT_DETAIL_DESC_DIMENSION: gettextCatalog.getString("Les dimensions ne sont pas au bon format pour le constat d'état"),
            ...
            DOC_UNIT_IMAGERESOLUTION: gettextCatalog.getString('Impossible de convertir la donnée.'),
            ...
            IMAGE_METADATA_FIELDS_MANDATORY: gettextCatalog.getString('Impossible de mettre à jour la liste des métadonnées, le {{$0}} est manquant.'),
            IMAGE_METADATA_SAME_PROPERTY_EXIST: gettextCatalog.getString('Impossible de mettre à jour la liste des métadonnées. <br> Une propriété existe déjà: <br>Propriété: {{$0}}, Champs: {{$1}},  Valeur: {{$2}}'),
            IMAGE_METADATA_PROPERTY_USED: gettextCatalog.getString('Impossible de mettre à jour la métadonnées {{$0}}. <br> La métadonnée est utilisée dans une unité documentaire.'),
            IMAGE_METADATA_CANT_PARSE: gettextCatalog.getString('Au moins une propriété ne respecte pas le bon format.'),
