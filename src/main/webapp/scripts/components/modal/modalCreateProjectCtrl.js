(function () {
    ...
    angular.module('numaHopApp.controller').controller('ModalCreateProjectCtrl', ModalCreateProjectCtrl);

    function ModalCreateProjectCtrl($scope, $uibModalInstance, gettextCatalog, $location, $timeout, MessageSrvc, DocUnitBaseService, NumahopEditService, ProjectSrvc, NumaHopInitializationSrvc) {
        var mainCtrl = this;
