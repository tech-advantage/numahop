(function () {
    ...
    angular.module('numaHopApp.service').factory('WebsocketSrvc', function ($cookies, $http, $q, $location, $rootScope, codeSrvc, MessageSrvc, Principal) {
        var service = {};
        ...
        function sendActivity() {
            if (stompClient !== null && stompClient.connected) {
                stompClient.send('/topic/activity', {}, angular.toJson({ page: $location.path() }));
            }
        }
