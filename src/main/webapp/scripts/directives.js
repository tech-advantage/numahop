(function () {
    ...
    angular.module('numaHopApp.directive')
        .directive('activeMenu', function (gettextCatalog, tmhDynamicLocale) {
            return {
                restrict: 'A',
    ...
    angular.module('numaHopApp.directive')
        .directive('passwordStrengthBar', function () {
            return {
                replace: true,
                restrict: 'E',
                template: '<div id="strength">' + '<small translate>Force du mot de passe :</small>'
                    + '<ul id="strengthBar">'
    ...
    angular.module('numaHopApp.directive')
        .directive('ngBindCompileHtml', function ($compile) {
