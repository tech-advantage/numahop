(function () {
    ...
    angular.module('numaHopApp.controller')
        .controller('CheckConfigurationCtrl', CheckConfigurationCtrl);

    function CheckConfigurationCtrl($location, $scope, $timeout, $q,
        CheckConfigurationSrvc, StringTools, NumahopStorageService, NumaHopInitializationSrvc) {
