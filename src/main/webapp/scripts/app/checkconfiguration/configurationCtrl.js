(function () {
    ...
    angular.module('numaHopApp.controller').controller('CheckConfigurationCtrl', CheckConfigurationCtrl);

    function CheckConfigurationCtrl($location, $scope, $timeout, $q, CheckConfigurationSrvc, StringTools, NumahopStorageService, NumaHopInitializationSrvc) {
        ...
        $scope.configurationInclude = 'scripts/app/checkconfiguration/configurationEdit.html';
        $scope.configuration = null;

        var FILTER_STORAGE_SERVICE_KEY = 'check_configurations';
        ...
        function create() {
            ...
            $location.path('/checkconfiguration/checkconfiguration').search({ id: null, new: true });
        }
        function edit(configuration) {
            ...
            $location.path('/checkconfiguration/checkconfiguration').search(search);
        }
        ...
        function filterConfigurations() {
            ...
            return CheckConfigurationSrvc.search(searchParams).$promise;
        }
