(function () {
    ...
    angular.module('sem.toggle-informations', [])
        ...
        .provider("$semInfos", function () {
            this.$get = [function () {
                ...
                menuFn.show = function show() {
                    $("#sem-infos a[data-toggle='dropdown']").attr("data-toggle", "collapse").each(function (index, value) {
                        var id = $(value).attr("href");
                ...
                menuFn.hide = function hide() {
                    $("#sem-infos a[data-toggle='collapse']").attr("data-toggle", "dropdown").each(function (index, value) {
                        var id = $(value).attr("href");
