(function() {
    ...
    angular.module('sem.toggle-filters', [])
        ...
        .provider("$semFilters", function() {
            this.$get = [function() {
                ...
                menuFn.show = function show() {
                    $("#sem-filters a[data-toggle='dropdown']").attr("data-toggle", "collapse").each(function(index, value) {
                        var id = $(value).attr("href");
                ...
                menuFn.hide = function hide() {
                    $("#sem-filters a[data-toggle='collapse']").attr("data-toggle", "dropdown").each(function(index, value) {
                        var id = $(value).attr("href");
