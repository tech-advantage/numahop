(function () {
    ...
    angular.module('numaHopApp.service').factory('WorkflowSrvc', function ($resource, codeSrvc, CONFIGURATION) {
        var service = $resource(
            CONFIGURATION.numahop.url + 'api/rest/workflow/:id',
            {
                id: '@identifier',
            },
            {
        ...
        service.statesToForceReinit = ['VALIDATION_CONSTAT_ETAT', 'PREREJET_DOCUMENT', 'PREVALIDATION_DOCUMENT', 'VALIDATION_DOCUMENT', 'VALIDATION_NOTICES'];

        service.status = ['NOT_STARTED', 'PENDING', 'CANCELED', 'FAILED', 'TO_WAIT', 'TO_SKIP', 'WAITING', 'WAITING_NEXT_COMPLETED', 'SKIPPED', 'FINISHED'];
    ...
    angular.module('numaHopApp.service').factory('WorkflowModelSrvc', function ($resource, CONFIGURATION) {
        var service = $resource(
            CONFIGURATION.numahop.url + 'api/rest/workflow_model/:id',
            {
                id: '@identifier',
            },
            {
    ...
    angular.module('numaHopApp.service').factory('WorkflowGroupSrvc', function ($resource, CONFIGURATION) {
        var service = $resource(
            CONFIGURATION.numahop.url + 'api/rest/workflow_group/:id',
            {
                id: '@identifier',
            },
            {
