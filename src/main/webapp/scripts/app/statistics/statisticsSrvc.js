(function () {
    ...
    angular.module('numaHopApp.service').factory('StatisticsSrvc', function ($httpParamSerializer, $resource, codeSrvc, CONFIGURATION) {
        var service = $resource(
            CONFIGURATION.numahop.url + 'api/rest/statistics/:stype',
            {
                stype: '@stype',
            },
            {
