(function () {
    ...
    angular.module('numaHopApp.controller')
        .controller('StatisticsDashboardProjectProgressCtrl', StatisticsDashboardProjectProgressCtrl);

    function StatisticsDashboardProjectProgressCtrl($q, codeSrvc, gettextCatalog, HistorySrvc, LibrarySrvc,
        ...
        function getPageOfLots(params) {
            ...
            return StatisticsSrvc.lotProgress(params).$promise
                // Chargement des stats sur les projets
