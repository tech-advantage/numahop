(function () {
    ...
    angular.module('numaHopApp.controller').controller('StatisticsDashboardProfileActivityCtrl', StatisticsDashboardProfileActivityCtrl);

    function StatisticsDashboardProfileActivityCtrl(
        $q,
        codeSrvc,
        gettextCatalog,
        HistorySrvc,
