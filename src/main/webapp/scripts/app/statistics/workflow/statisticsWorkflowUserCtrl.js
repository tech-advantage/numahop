(function () {
    ...
    angular.module('numaHopApp.controller').controller('StatisticsWorkflowUserCtrl', StatisticsWorkflowUserCtrl);

    function StatisticsWorkflowUserCtrl($q, codeSrvc, DeliverySrvc, gettextCatalog, HistorySrvc, LibrarySrvc, LotSrvc, NumahopStorageService, ProjectSrvc, StatisticsSrvc) {
        var statCtrl = this;
        ...
        var FILTER_STORAGE_SERVICE_KEY = 'stat_workflow_user';
        ...
        function getPage() {
            ...
            statCtrl.items = StatisticsSrvc.workflowUser(params);
