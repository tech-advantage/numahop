(function () {
    ...
    angular.module('numaHopApp.controller')
        .controller('StatisticsWorkflowUserCtrl', StatisticsWorkflowUserCtrl);

    function StatisticsWorkflowUserCtrl($q, codeSrvc, DeliverySrvc, gettextCatalog, HistorySrvc, LibrarySrvc,
        LotSrvc, NumahopStorageService, ProjectSrvc, StatisticsSrvc) {
