(function () {
    ...
    angular.module('numaHopApp.controller')
        .controller('UserAuthorizationCtrl', function ($filter, $routeParams, $scope,
            UserAuthorizationSrvc, codeSrvc, gettextCatalog, HistorySrvc, uibPaginationConfig) {
            ...
            $scope.$watch("orderBy", function (value) {
                ...
                true);    // comparaison par valeur et non par référence
