(function () {
    ...
    angular.module('numaHopApp.controller')
        .controller('IAConfigurationCtrl', IAConfigurationCtrl);

    function IAConfigurationCtrl($location, $scope, $timeout, $q,
        IAConfigurationSrvc, StringTools, NumahopStorageService, NumaHopInitializationSrvc) {
