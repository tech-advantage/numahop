(function () {
    ...
    angular.module('numaHopApp.controller').controller('IAConfigurationCtrl', IAConfigurationCtrl);

    function IAConfigurationCtrl($location, $scope, $timeout, $q, IAConfigurationSrvc, StringTools, NumahopStorageService, NumaHopInitializationSrvc) {
        ...
        $scope.configurationInclude = 'scripts/app/platformconfiguration/iaconfigurationEdit.html';
        $scope.configuration = null;

        var FILTER_STORAGE_SERVICE_KEY = 'ia_configurations';
        ...
        function create() {
            ...
            $location.path('/platformconfiguration/iaconfiguration').search({ id: null, mode: 'edit' });
        }
        function edit(configuration) {
            ...
            $location.path('/platformconfiguration/iaconfiguration').search(search);
        }
        ...
        function filterConfigurations() {
            ...
            return IAConfigurationSrvc.search(searchParams).$promise;
        }
