(function () {
    ...
    angular.module('numaHopApp.controller')
        .controller('ExportFTPConfigurationCtrl', ExportFTPConfigurationCtrl);

    function ExportFTPConfigurationCtrl($location, $scope, $timeout, $q, ExportFTPConfigurationSrvc, 
