(function () {
    ...
    angular.module('numaHopApp.controller').controller('ExportFTPConfigurationCtrl', ExportFTPConfigurationCtrl);

    function ExportFTPConfigurationCtrl($location, $scope, $timeout, $q, ExportFTPConfigurationSrvc, StringTools, NumahopStorageService, NumaHopInitializationSrvc) {
        ...
        $scope.configurationInclude = 'scripts/app/platformconfiguration/exportftpconfigurationEdit.html';
        $scope.configuration = null;

        var FILTER_STORAGE_SERVICE_KEY = 'export_ftp_configurations';
        ...
        function create() {
            ...
            $location.path('/platformconfiguration/exportftpconfiguration').search({ id: null, new: true });
        }
        function edit(configuration) {
            ...
            $location.path('/platformconfiguration/exportftpconfiguration').search(search);
        }
        ...
        function filterConfigurations() {
            ...
            return ExportFTPConfigurationSrvc.search(searchParams).$promise;
        }
