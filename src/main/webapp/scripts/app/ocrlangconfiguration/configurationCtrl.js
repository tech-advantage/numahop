(function () {
    ...
    angular.module('numaHopApp.controller')
        .controller('OcrLangConfigurationCtrl', OcrLangConfigurationCtrl);

    function OcrLangConfigurationCtrl($location, $scope, $timeout, $q,
                    OcrLangConfigurationSrvc, StringTools, NumahopStorageService, NumaHopInitializationSrvc) {
