(function () {
    ...
    angular.module('numaHopApp.controller').controller('OcrLangConfigurationCtrl', OcrLangConfigurationCtrl);

    function OcrLangConfigurationCtrl($location, $scope, $timeout, $q, OcrLangConfigurationSrvc, StringTools, NumahopStorageService, NumaHopInitializationSrvc) {
        ...
        $scope.configurationInclude = 'scripts/app/ocrlangconfiguration/configurationEdit.html';
        $scope.configuration = null;

        var FILTER_STORAGE_SERVICE_KEY = 'ocr_lang_configurations';
        ...
        function create() {
            ...
            $location.path('/ocrlangconfiguration/ocrlangconfiguration').search({ id: null, new: true });
        }
        function edit(configuration) {
            ...
            $location.path('/ocrlangconfiguration/ocrlangconfiguration').search(search);
        }
        ...
        function filterConfigurations() {
            ...
            return OcrLangConfigurationSrvc.search(searchParams).$promise;
        }
