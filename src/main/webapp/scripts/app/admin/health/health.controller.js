(function () {
    ...
    angular.module('numaHopApp').controller('HealthController', function ($scope, MonitoringService, SearchSrvc, MessageSrvc, gettext) {
        ...
        $scope.transformHealthData = function (data) {
            var response = [];
            $scope.flattenHealthData(response, null, data.components);
            return response;
        };
