(function () {
    ...
    angular
        ...
        .controller(
            'Z3950ServerEditCtrl',
            function ($location, $q, $routeParams, $scope, $timeout, codeSrvc, gettext, gettextCatalog, HistorySrvc, MessageSrvc, ModalSrvc, ListTools, ValidationSrvc, Z3950ServerSrvc, DocUnitBaseService) {
                // Initialisation
                ...
                $scope.delete = function (z3950Server) {
                    ModalSrvc.confirmDeletion(z3950Server.name).then(function () {
                        z3950Server.$delete(function (value, responseHeaders) {
                            ...
                            ListTools.findAndRemoveItemFromLists(z3950Server, $scope.newServers, $scope.displayedServers, $scope.servers);
                            $scope.backToList();
                        });
                    });
                };
