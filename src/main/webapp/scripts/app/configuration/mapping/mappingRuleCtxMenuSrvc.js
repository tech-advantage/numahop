(function () {
    ...
    angular.module('numaHopApp.service').factory('MappingRuleCtxMenuSrvc', MappingRuleCtxMenuSrvc);
    ...
    function MappingRuleCtxMenuSrvc() {
        ...
        function wrapWith(modelValue, $event, fnPrefix, defaultFnArgs, fnSuffix) {
            ...
            // du texte est sélectionné: on le wrap dans la fonction
                ...
                modelValue = modelValue.substring(0, start) + fnPrefix + modelValue.substring(start, end) + fnSuffix + modelValue.substring(end);
            }
            return modelValue;
        }
        /**
