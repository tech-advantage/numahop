(function () {
    ...
    angular.module('numaHopApp.service')
        .factory('MappingRuleEadSrvc', MappingRuleEadSrvc);
    ...
    function MappingRuleEadSrvc(MappingRuleCtxMenuSrvc) {
        ...
        function menuItem(rule, field, label, expression) {
            return [label, function ($itemScope, $event) {
