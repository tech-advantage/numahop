(function () {
    ...
    angular.module('numaHopApp.controller')
        .controller('CheckSlipConfEditCtrl', CheckSlipConfEditCtrl);

    function CheckSlipConfEditCtrl($location, $q, $route, $routeParams, $scope, $timeout, CondreportDescValueSrvc,
        CheckSlipConfSrvc, DocUnitBaseService, gettext, gettextCatalog, MessageSrvc, ValidationSrvc ) {
