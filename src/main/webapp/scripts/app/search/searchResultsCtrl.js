    ...
    function SearchResultsCtrl($q, $timeout, $window, gettextCatalog, HistorySrvc, NumahopStorageService, SearchSrvc, SelectionSrvc) {
        ...
        searchCtrl.sortOptions = {
            DOCUNIT: [
                ...
                { value: "DOCUNIT:pgcnId.ci_ai_phr=ASC", label: "PgcnId ", group: "PgcnId" },  // &#xf160;
                { value: "DOCUNIT:pgcnId.ci_ai_phr=DESC", label: "PgcnId ", group: "PgcnId" },  // &#xf161;
                { value: "DOCUNIT:label.ci_ai_phr=ASC", label: "Libellé ", group: "Libellé" },
                { value: "DOCUNIT:label.ci_ai_phr=DESC", label: "Libellé ", group: "Libellé" }
            ],
            CONDREPORT: [
            ...
            PROJECT: [
                ...
                { value: "PROJECT:name.ci_ai_phr=ASC", label: "Nom ", group: "Nom" },
                { value: "PROJECT:name.ci_ai_phr=DESC", label: "Nom ", group: "Nom" }
            ],
            LOT: [
                { value: "LOT:_score=DESC", label: "Pertinence" },
                { value: "LOT:label.ci_ai_phr=ASC", label: "Libellé ", group: "Libellé" },
                { value: "LOT:label.ci_ai_phr=DESC", label: "Libellé ", group: "Libellé" }
            ],
            TRAIN: [
                { value: "TRAIN:_score=DESC", label: "Pertinence" },
                { value: "TRAIN:label.ci_ai_phr=ASC", label: "Libellé ", group: "Libellé" },
                { value: "TRAIN:label.ci_ai_phr=DESC", label: "Libellé ", group: "Libellé" }
            ],
            DELIVERY: [
                { value: "DELIVERY:_score=DESC", label: "Pertinence" },
                { value: "DELIVERY:label.ci_ai_phr=ASC", label: "Libellé ", group: "Libellé" },
                { value: "DELIVERY:label.ci_ai_phr=DESC", label: "Libellé ", group: "Libellé" }
            ]
        };
        ...
        function getPage(type) {
            if (!searchCtrl.pagination.busy) {
                ...
                return SearchSrvc.search(searchCtrl.params).$promise
