(function () {
    ...
    angular.module('numaHopApp.controller').controller('TrainEditCtrl', TrainEditCtrl);

    function TrainEditCtrl(
        $location,
        $q,
        $routeParams,
        $scope,
        ...
        function deleteTrain(train) {
            ModalSrvc.confirmDeletion(gettextCatalog.getString('le train {{label}}', train)).then(function () {
