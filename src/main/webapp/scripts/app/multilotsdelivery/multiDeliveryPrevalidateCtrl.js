(function () {
    ...
    angular.module('numaHopApp.controller')
        .controller('MultiDeliveryPrevalidateCtrl', MultiDeliveryPrevalidateCtrl);

    function MultiDeliveryPrevalidateCtrl($routeParams, $scope, MultiDeliverySrvc, codeSrvc,
        ...
        function deliver() {
            ...
            MultiDeliverySrvc.deliver(params, wrapper).$promise
                .then(function () {
        ...
        function loadPreDelivery() {
            MultiDeliverySrvc.predeliver({ id: $routeParams.id },
