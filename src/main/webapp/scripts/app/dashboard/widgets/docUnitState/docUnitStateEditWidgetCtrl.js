(function () {
    ...
    angular.module('numaHopApp.controller').controller('DocUnitStateEditWidgetCtrl', DocUnitStateEditWidgetCtrl);

    function DocUnitStateEditWidgetCtrl($q, config, gettextCatalog, LibrarySrvc, LotSrvc, ProjectSrvc, WorkflowSrvc) {
        var mainCtrl = this;
