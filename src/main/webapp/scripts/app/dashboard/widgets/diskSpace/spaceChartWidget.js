(function () {
    ...
    angular.module('numaHopApp')
        ...
        .controller('SpaceChartWidgetCtrl', function ($q, $scope, config, DeliverySrvc) {
            ...
            function init() {
                if (isConfigured()) {
                    getDiskUsageInfos().then(function (chartData) {
                        ...
                        mainCtrl.labels = ['Utilisé ' + bytesToSize(chartData['occupe']), 'Disponible ' + bytesToSize(chartData['disponible'])];
