(function () {
    ...
    angular.module('numaHopApp.controller').controller('SampleStateEditWidgetCtrl', SampleStateEditWidgetCtrl);

    function SampleStateEditWidgetCtrl($q, config, gettextCatalog, DeliverySrvc, LibrarySrvc, LotSrvc, ProjectSrvc) {
        var mainCtrl = this;
