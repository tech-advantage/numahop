(function () {
    ...
    angular.module('numaHopApp.controller').controller('DeliveryStateEditWidgetCtrl', DeliveryStateEditWidgetCtrl);

    function DeliveryStateEditWidgetCtrl($q, config, gettextCatalog, DeliverySrvc, LibrarySrvc, LotSrvc, ProjectSrvc) {
        var mainCtrl = this;
        ...
        mainCtrl.options = {
            ...
            status: {
                ...
                trackby: 'identifier',
                data: DeliverySrvc.config.status,
                multiple: true,
                'allow-clear': true,
            },
        };
