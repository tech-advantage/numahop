(function () {
    ...
    angular.module('numaHopApp.service').factory('PageCheckSrvc', function ($resource, CONFIGURATION) {
        var service = $resource(
            CONFIGURATION.numahop.url + 'api/rest/check/:id',
            {
                id: '@identifier',
            },
            {
                ...
                getCondReportForSamplePage: {
                    method: 'GET',
                    isArray: true,
                    params: {
                        getcondreportforsamplepage: true,
                    },
                },
                setErrors: {
                    method: 'POST',
