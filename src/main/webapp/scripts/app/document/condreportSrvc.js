(function () {
    ...
    angular.module('numaHopApp.service')
        .factory('CondreportSrvc', function ($resource, CONFIGURATION, gettextCatalog) {
            var service = $resource(CONFIGURATION.numahop.url + 'api/rest/condreport/:id', { id: '@identifier' },
                {
                    search: {
                        method: 'POST',
                        isArray: false,
    ...
    angular.module('numaHopApp.service')
        .factory('CondreportDetailSrvc', function ($resource, CONFIGURATION) {
            var service = $resource(CONFIGURATION.numahop.url + 'api/rest/condreport_detail/:id', { id: '@identifier' },
               {
                confirmInitialValid: {
                    method: 'POST',
                    isArray: false,
    ...
    angular.module('numaHopApp.service')
        .factory('CondreportAttachmentSrvc', function ($resource, CONFIGURATION) {
