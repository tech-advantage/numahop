(function () {
    ...
    function ExportSrvc(CONFIGURATION, $resource) {
        return $resource(CONFIGURATION.numahop.url + 'api/rest/export/:svc',
            { svc: '@svc' },
            {
                toCines: {
                    method: 'POST',
    ...
    function ExportCinesSrvc($resource, codeSrvc, CONFIGURATION) {
        var service = $resource(CONFIGURATION.numahop.url + 'api/rest/export/cines/:id', {
            id: '@identifier'
        }, {
                export: {
                    method: 'GET',
    ...
    function ExportOmekaSrvc($resource, codeSrvc, CONFIGURATION) {
        var service = $resource(CONFIGURATION.numahop.url + 'api/rest/export/omeka/:id', {
            id: '@identifier'
        }, {
                prepare: {
                    method: 'GET',
    ...
    function ExportInternetArchiveSrvc($resource, codeSrvc, CONFIGURATION) {
        var service = $resource(CONFIGURATION.numahop.url + 'api/rest/internet_archive/:id', {
            id: '@identifier'
        }, {
                prepare: {
                    method: 'GET',
