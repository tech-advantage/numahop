(function () {
    ...
    angular.module('numaHopApp.controller').controller('DocUnitAllOperationsCtrl', DocUnitAllOperationsCtrl);

    function DocUnitAllOperationsCtrl($q, $routeParams, $scope, $timeout, gettext, codeSrvc, LockSrvc, MessageSrvc, NumaHopInitializationSrvc) {
        var self = this;
        ...
        self.init = function (parentCtrl) {
            ...
            loadOptions(parentCtrl.docUnit.library.identifier, parentCtrl.docUnit.project ? parentCtrl.docUnit.project.identifier : null);
        ...
        function loadOptions(libraryId, projectId) {
            ...
            $q.all([
                ...
                _.each(data[3], function (l) {
                    if ((l.type === 'PHYSICAL' && l.status === 'CREATED') || (self.entity.lot && self.entity.lot.identifier === l.identifier)) {
